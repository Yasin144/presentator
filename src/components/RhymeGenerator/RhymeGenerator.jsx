...
export default function RhymeGenerator() {
  ...
  const [singerStyle, setSingerStyle] = useState('warm young female solo singer');
      ...
      <div className="rg-grid">
        <section className="rg-card">
          ...
          <div className="rg-advanced">
            ...
            <div className="rg-control"><label className="rg-label">Singer · applies to full generation</label><select className="rg-select" value={singerStyle} disabled={busy} onChange={event => setSingerStyle(event.target.value)}><option>warm young female solo singer</option><option>gentle young male solo singer</option><option>bright child-friendly female solo singer</option></select></div>
